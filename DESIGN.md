...
- **打样台:** 同一玻璃语言，一个大井只交 `.ai`。不要做成审稿的双井。不要再收平面 PDF。打样台只交稿和列单；点进度或已出图进单独打样单。打样台和打样单主区白底深字（`#ffffff`，不是紫雾台；深色主题也是）。打样单一屏三列等高：正面+侧面、反面+侧面、GLB；每张图右上角 44 玻璃圆钮下载。页头右上「下载+PPT」（没写成 PPT 仍显示，点了出「PPT 没写成，白底仍可下」）；有合成 PDF 时旁边还能下 PDF。点下载出底部玻璃条「正在下载…」，点不着、不挡手。GLB 全屏后水平垂直居中；截图时下载钮藏起来；全屏被拒出「全屏打不开」。GLB 中性环境、曝光跟静帧，接触阴影。已经出过的白底图要重新打样才会变。打样单 PDF 槽按源图比例 contain，不拉长。
...
| 待她判 | 核对页：图上真框 + 钉在框中心 + 整页最上面核对窗（进页展开叠在左侧栏，可随意拖，不挤页图；窗可盖画布，夹住不盖页头签字；收起有动画，边框八向缩放）；钉和框分开关；没有位置就不画假钉；OCR 不清必须写「待人工确认」 |
| 她提交 | 「已记录你的结论，不是系统过审」 |
...
| 打样台可跑 | 选稿 → 跑 worker → 点进打样单一屏三图：正面+侧面、反面+侧面、GLB。主区白底。每张图右上角 44 玻璃圆钮下载；页头「下载+PPT」（没写成仍显示，点了出「PPT 没写成，白底仍可下」）；有 PDF 时旁边还能下 PDF。点下载底部玻璃条「正在下载…」，点不着。GLB 全屏居中；截图时下载钮藏起来；全屏被拒出「全屏打不开」。PDF 槽 contain。PPT 用两张白底写 OOXML，不依赖 Node；写不出才试演示文稿运行时。白底仍合成 PDF（页底先铺白；pymupdf 写不出且还没落盘才用已装 Pillow，不盖掉已写成的文件）。失败写清缺 Blender、缺刀线或套不上已登记刀模 |
