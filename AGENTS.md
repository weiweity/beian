...
- 完成报告区分文档/静态检查、本地测试、Windows L1、真实稿 L2 和生产发布；未执行的验证写明，不用计划、合成数据或旧快照证明当前验收。范围外建议不妨碍已授权工作结案。
...
- 完成报告写改动、验证、未执行项和当前阶段。Code、L0、杭州 L1、真实稿 L2、UAT、生产发布分别举证；不以合成数据或日期证明验收通过。
