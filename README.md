...
| `docs/adr-007-packaging-render-fidelity.md` | 包装 3D 渲染真实感、材质、棚光、清晰度、能力矩阵与评测合同；RF-00–06 已有 Code/L0；RF-07 显式棚光与三变换对照已有 Code/普通 L0，仅诊断 registry；生产注册、原生 Windows、RF-08+、批准基线及 L1/L2/UAT 未完成 |
